...
Config.setup do |config|
  ...
  # Ability to remove elements of the array set in earlier loaded settings
  # file. For example value: '--'.
  #
  ...
  #
  # Reading variables from ENV is case-sensitive. If you define lowercase
  # value below, ensure your ENV variables are prefixed in the same way.
  #
